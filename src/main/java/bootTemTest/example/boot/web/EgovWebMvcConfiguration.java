...
import bootTemTest.example.cmmn.web.EgovBindingInitializer;
import bootTemTest.example.cmmn.web.EgovImgPaginationRenderer;
...
public class EgovWebMvcConfiguration extends WebMvcConfigurationSupport {
	...
	public void addViewControllers(ViewControllerRegistry registry) {
		registry.addViewController("/cmmn/validator").setViewName("cmmn/validator");
...
//        tilesConfigurer.setDefinitions("/jsp/tiles/tiles-layout.xml");
